...
Microvison Service Management System  |  GRD v1.1  |  Page 2 of 27 1. Project Overview  
...
snapshotted and stored permanently — future edit s to the preset do not affect existing complaints.  
...
LED; Complaint only for Cooler  Used when a single visit covers 
both products  
...
option is shown as a banner. Admin can choose to r eopen or continue creating a new complaint.  
...
Microvison Service Management System  |  GRD v1.1  |  Page 10 of 27 • accepted → going: optional, skippable, service centre only.  
...
Microvison Service Management System  |  GRD v1.1  |  Page 14 of 27 Out-of-warranty complaints with no admin extras do not appear in the billing tab — they have no bill from 
...
Microvison Service Management System  |  GRD v1.1  |  Page 16 of 27 • Complaint type (installation, complaint)  
...
creation  No — locked permanently  
Petrol / diesel  3-round edit process (admin → 
SC → admin)  Locked after 3rd edit  
Approved extra charges  SC requests approved by 
admin, or admin -added  No — locked after approval  
Total Preset + petrol + approved 
extras  Auto-calculated  
...
contributing a specific item  If added, a bill is generated for 
these extras only  
...
payment  Complaint closes as tracking record only. No 
Microvison bill generated.  
Out of warranty, SC does not fill customer 
payment field  System blocks final status submission until the 
field is filled.  
...
customerName  String   
Microvison Service Management System  |  GRD v1.1  |  Page 24 of 27 Field  Type  Notes  
phone1  String   
phone2  String  Optional  
localAddress  String   
